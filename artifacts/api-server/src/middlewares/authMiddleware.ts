...
import { type AuthUser, clearSession, getOidcConfig, getSessionId, getSession, updateSession, type SessionData } from "../lib/auth";
...
declare global {
  namespace Express {
    ...
    export interface AuthedRequest { user: User; }
  }
}
